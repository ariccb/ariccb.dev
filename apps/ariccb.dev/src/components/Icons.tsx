...
export function JavaScriptIcon(props: ComponentProps<'svg'>) {
  return (
    ...
    >
      <title>TypeScript Icon</title>
      <path d="M 0,0 H 24 V 24 H 0 Z m 18.3467,20.1196 c -1.1124,0 -1.7414,-0.5802 -2.2248,-1.3695 l -1.8328,1.0648 c 0.6621,1.3081 2.0153,2.3062 4.1098,2.3062 2.142,0 3.7371,-1.1123 3.7371,-3.1428 0,-1.8834 -1.0819,-2.7212 -2.9981,-3.5429 l -0.5638,-0.2415 c -0.9676,-0.419 -1.3867,-0.6929 -1.3867,-1.3695 0,-0.5474 0.4187,-0.9665 1.0793,-0.9665 0.6476,0 1.0647,0.2731 1.4514,0.9665 l 1.7562,-1.1276 c -0.7429,-1.3067 -1.7737,-1.8058 -3.2076,-1.8058 -2.0141,0 -3.3029,1.2877 -3.3029,2.9791 0,1.8362 1.0811,2.7048 2.7086,3.3981 l 0.5638,0.2419 c 1.0286,0.4499 1.6419,0.7238 1.6419,1.4971 0,0.6454 -0.597,1.1124 -1.5314,1.1124 z M 9.60647,20.1055 c -0.77486,0 -1.09714,-0.5314 -1.45143,-1.16 L 6.31923,20.057 c 0.53181,1.1255 1.57753,2.06 3.38324,2.06 1.99843,0 3.36763,-1.0629 3.36763,-3.3981 v -7.6991 h -2.2552 v 7.6686 c 0,1.1272 -0.4675,1.4171 -1.20843,1.4171 z" />
    </svg>
  );
}
...
export function MaterialUiIcon(props: ComponentProps<'svg'>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"

...
function DeveloperToAiEngineerSection() {
  return (
    <section className={clsx('content-wrapper mb-10', 'lg:mb-24')}>
      <div
        className={clsx(
          'border-accent-200/70 via-accent-50/40 to-accent-100/70 shadow-accent-900/5 relative overflow-hidden rounded-[2.5rem] border bg-gradient-to-br from-white p-6 shadow-xl backdrop-blur',
          'dark:border-accent-900/50 dark:to-accent-950/20 dark:from-slate-950 dark:via-slate-950',
          'md:p-8 lg:p-12'
        )}
      >
        ...
        <div className={clsx('relative mx-auto max-w-5xl')}>
          ...
          <blockquote>
            ...
            >
              <p>
                A few years ago, a portfolio could mostly say “here’s the stack
                I use” and “here are the apps I’ve built.” That still matters,
                but it no longer explains the work I’m doing day to day.
              </p>
              <p>
                The bigger shift has been learning how to design the workflow
                around the code: how requests are clarified, specs are shaped,
                repo context gets pulled in, agents are guided, hallucinations
                are constrained, and outputs are reviewed before production
                changes.
              </p>
              <p>
                ...
                communication. The leverage is building the rails that make
                faster output trustworthy.
              </p>
            </div>
          </blockquote>
        </div>

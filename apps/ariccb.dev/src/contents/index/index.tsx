...
function ExploreNextSection() {
  return (
    <section className={clsx('content-wrapper mb-16', 'lg:mb-28')}>
      <div
        className={clsx(
          'bg-white/85 relative overflow-hidden rounded-[2.25rem] border border-slate-200 p-6 shadow-lg backdrop-blur',
          'dark:border-secondary-900/40 dark:bg-gradient-to-br dark:from-slate-950 dark:via-slate-950 dark:to-slate-900/90',
          'md:p-8 lg:p-10'
        )}
      >
        <div
          aria-hidden="true"
          className={clsx(
            'bg-accent-500/10 absolute inset-0',
            'dark:bg-[radial-gradient(circle_at_18%_12%,rgb(var(--tw-ta-accent-500)/0.16),transparent_32%),radial-gradient(circle_at_82%_28%,rgb(var(--tw-secondary-500)/0.14),transparent_30%),linear-gradient(135deg,transparent,rgb(15_23_42/0.38))]'
          )}
        />
        <div
          aria-hidden="true"
          className={clsx(
            'bg-secondary-300/20 absolute -right-20 -top-20 hidden h-56 w-56 rounded-full blur-3xl dark:block',
            ...
            {nextLinks.map((item) => (
              <NextLink
                ...
                className={clsx(
                  ...
                  'hover:border-accent-200 hover:-translate-y-1 hover:shadow-xl',
                  'dark:hover:border-secondary-800/70 dark:border-slate-800/80 dark:bg-slate-900/70 dark:hover:bg-slate-900'
                )}
              >
                <div
                  aria-hidden="true"
                ...
                <div
                  className={clsx(
                    ...
                    'dark:text-accent-200 dark:group-hover:bg-secondary-950/50 dark:bg-slate-800/80'
                  )}
                >
                  Go this way

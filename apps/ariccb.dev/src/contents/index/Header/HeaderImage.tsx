...
function HeaderImage() {
  ...
  return (
    <div
      ...
      style={{
        maskImage: `url("data:image/svg+xml,%3Csvg width='603' height='590' fill='none' viewBox='0 0 603 590' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='m0 0v393h228v9.5c0 200 83.947 187.5 187.5 fill='%23000'/%3E%3C/svg%3E%0A")`,
        WebkitMaskImage: `url("data:image/svg+xml,%3Csvg width='603' height='590' fill='none' viewBox='0 0 603 590' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='m0 0v363h228v9.4c0 103.55 83.947 187.5 187.5 187.5s187.5-83.947 187.5-187.5v-402' fill='%23000'/%3E%3C/svg%3E%0A")`,
      }}
    >
      <div
        className={clsx(
      ...
      >
        <div className={clsx('absolute right-0 bottom-0 overflow-hidden')}>
          ...
          >
            <Image
              alt="Aric Crosson Bouwers Headshot"
